...
import { CLIENT_SECRET,CLIENT_ID } from './GithubCredentials'
...
const GithubSearchApp = () => {
  ...
  const submitSearch = async(e) => {
    e.preventDefault();
    let dataURL = `https://api.github.com/users/${githubUser}?client_id=
    ...
    let dataURL2 = `https://api.github.com/users/${githubUser}/repos?client_id=
    ${CLIENT_ID}&client_secret=${CLIENT_SECRET}`;
  ...
  return (
    <>
        <div className="container mt-6">
            <div className="row">
                <div className="col">
                    <p className="display-3 ">Github Pofile Search</p>
                    <p className="lead font-weight-bold">Search a Github 
                    Profile to see his/her activities</p>
